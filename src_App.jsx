      ...
      <main style={{ padding: "30px 20px", maxWidth: 900, margin: "0 auto" }}>
        {tab === "agenda" && (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 25 }}>
              <h1 style={{ fontFamily: "'Lora', serif", margin: 0 }}>Agenda Semanal</h1>
              ...
              {sortedAppts.map(a => {
                ...
                return (
                  <div key={a.id} style={{ background: "#fff", padding: 18, borderRadius: 15, display: "flex", alignItems: "center", gap: 20, boxShadow: "0 2px 5px rgba(0,0,0,0.04)", borderLeft: `5px solid ${STATUS_COLORS[a.status].dot}` }}>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ fontWeight: 700, fontSize: 16 }}>{pt?.name || "Paciente no encontrado"}</div>
        ...
        {tab === "pacientes" && (
          <>
            ...
            <input placeholder="Buscar paciente o dueño..." value={search} onChange={e => setSearch(e.target.value)} style={{ ...inputStyle, marginBottom: 20 }} />
